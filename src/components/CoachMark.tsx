 ...
 *
 * 덮개는 `pointer-events: none`이라 클릭이 그대로 통과하고, 진행은 App이 창
 * 전체에서 가로챕니다(하단 고정 배너·탭 위에도 떠야 해서 zIndex는 배너보다 높은 1000).
...
export function CoachMark({
  ...
  useEffect(() => {
    ...
    // 매 프레임 따라가요. 대상이 부드러운 스크롤로 움직이는 중일 수도 있고,
    // 당첨번호처럼 네트워크를 기다렸다 뒤늦게 그려지는 것도 있어서
